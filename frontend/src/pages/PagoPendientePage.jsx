...
export const PagoPendientePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-yellow-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center px-4 transition-colors duration-300">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-2xl shadow-xl dark:shadow-none p-8 text-center border border-gray-100 dark:border-slate-700">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2">Pago Pendiente</h1>
        
        <p className="text-gray-600 dark:text-slate-300 mb-8">
          Tu pago está siendo procesado. Esto puede tomar algunos minutos.
        </p>

        <div className="bg-yellow-50 dark:bg-slate-950 border border-yellow-200 dark:border-slate-700 rounded-lg p-4 mb-8 text-left">
          <h3 className="font-semibold text-gray-800 dark:text-slate-100 mb-2">¿Qué está sucediendo?</h3>
